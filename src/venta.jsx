...
const Venta = () => {
  ...
  const registrarVenta = async () => {
    ...
    let clienteData =
      clienteFrecuente === "Sí" && clienteSeleccionado
      ...
      if (result.isConfirmed) {
        try {
          ...
          for (const item of carrito) {
            ...
            // Obtener el inventario completo (o podrías usar getDoc directamente)
            const inventarioSnap = await getDocs(collection(db, "inventario"));
            const productoData = inventarioSnap.docs.find(
              (doc) => doc.id === item.id
            )?.data();
        ...
        <div className="sidebar">
          <div className="cliente-section">
            ...
            <select
              ...
              onChange={(e) => setClienteFrecuente(e.target.value)}
            >
          ...
          <div className="producto-section">
            ...
            <div className="cantidad-container">
              ...
              <input
                ...
                onChange={(e) =>
                  setCantidadProducto(Math.max(1, Number(e.target.value)))
                }
